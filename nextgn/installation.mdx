...
## Installing NextGN on local machine
...
Import the `database/data/nextgn.sql` file into your database. You can use a tool like phpMyAdmin or MySQL Workbench to import the file.
...
Open your web browser and visit `http://127.0.0.1:8000` to access the NextGN application.
