...
The default path to the admin panel is `/admin`. If you want to change it, follow the steps below:
...
2. Add the following line at the end of the file:
    ...
    ADMIN_PATH=admin
    ```
3. Replace the placeholder with the path you want to use (e.g., "dashboard", "control-panel", etc.).
