...
:::info
If you prefer to utilize sample data similar to our demo setup, you can import the `database/data/sample.sql` file after the `ticksify.sql` has been imported successfully. Please be aware that, to respect copyright restrictions, the sample data will not include any images.
:::
...
That's it! You have successfully installed Ticksify on your shared hosting. You may now continue to the next section to set up the application and access the admin panel.

## Setting up the application and accessing the admin panel

After Ticksify has been installed, the next step is to set up the application and access the admin panel.

### Setting up the application

The setup process includes the creation of an admin user and the configuration of the application's title and description.

:::tip
You may skip this step if you have imported our sample data.
:::

To set up the application, navigate to your website's URL eg. https://example.com/setup (replace example.com with your actual domain that you have configured in your .env file) and follow the on-screen instructions.


### Accessing the admin panel

To access the admin panel, navigate to your website's URL eg. https://example.com/agent (replace example.com with your actual domain that you have configured in your .env file) and log in using the credentials you created during the setup process.
