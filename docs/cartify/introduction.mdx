...
<div style={{ display: 'flex', justifyContent: 'center', paddingTop: '0.5rem', paddingBottom: '1rem' }}>
    ...
    <img src="https://img.shields.io/badge/release-2.0.0-success?logo=github" alt="" style={{border: 'none', borderRadius: 'unset', backgroundColor: 'transparent', padding: 0, marginLeft: '0.25rem'}} />
</div>
